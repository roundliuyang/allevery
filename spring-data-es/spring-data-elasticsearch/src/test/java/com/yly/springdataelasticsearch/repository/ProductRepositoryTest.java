...
import com.yly.springdataelasticsearch.Application;
...
public class ProductRepositoryTest {
    ...
    public void testInsert() {
        ...
        product.setName("芋道源码2");
        product.setSellPoint("愿半生编码，如一生老友2");
    ...
    public void testSelectByIds() {
        Iterable<ESProductDO> users = productRepository.findAllById(Arrays.asList(1, 13,2));
