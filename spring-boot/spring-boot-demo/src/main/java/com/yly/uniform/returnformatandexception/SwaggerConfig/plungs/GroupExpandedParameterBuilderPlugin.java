package com.yly.uniform.returnformatandexception.SwaggerConfig.plungs;
...
public class GroupExpandedParameterBuilderPlugin implements ExpandedParameterBuilderPlugin {
    ...
    public void apply(ParameterExpansionContext context) {
        // 附加额外配置
        com.yly.uniform.returnformatandexception.SwaggerConfig.plungs.GroupDocumentationType documentationType = (com.yly.uniform.returnformatandexception.SwaggerConfig.plungs.GroupDocumentationType) context.getDocumentationType();
        ...
        com.yly.uniform.returnformatandexception.SwaggerConfig.plungs.GroupModelPropertyBuilderPlugin.apply(peca, ParameterExpansionContextAnnotation::getAnnotation,
    ...
    public boolean supports(DocumentationType documentationType) {
        return documentationType instanceof com.yly.uniform.returnformatandexception.SwaggerConfig.plungs.GroupDocumentationType;
    }
