...
import com.yly.springdatamongodb.Application;
...
public class UserRepositoryTest {
    ...
    public void testUpdate() {
        // 查询用户
        Optional<UserDO> userResult = userRepository.findById(2);
    ...
    public void testSelectByIds() {
        Iterable<UserDO> users = userRepository.findAllById(Arrays.asList(1, 2));
